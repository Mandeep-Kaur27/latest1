...
const Home = () => {
  return (
    <div className="home1">
      <footer className="footer-container">
        <div className="footer1">
          ...
          <div className="comunity3">
            ...
            <div className="collections2">Collections</div>
      ...
      <section className="cta-container" id="loop">
        <div className="cta1">
          <div className="container18" />
          <div className="email1">
            <button className="button2">
              <div className="medium2">Subscribe</div>
            </button>
            <input className="form1" type="text" placeholder="Your Email" />
          </div>
          ...
          <div className="stay-in-the1">Stay in the loop</div>
        </div>
      </section>
      <div className="popular-articles">
        <div className="nft-21">
          ...
          <div className="profile">
            ...
            <img
              className="image-placeholder-icon32"
              alt=""
      ...
      <section className="popular-artist-wrapper">
        <div className="popular-artist">
          <div className="artist-9">
            ...
            <img
              className="image-placeholder-icon37"
              alt=""
              src="/image-placeholder41.svg"
            />
            <div className="div5">09</div>
          </div>
          ...
          <div className="artist-4">
            ...
            <img
              className="image-placeholder-icon42"
              alt=""
              src="/image-placeholder41.svg"
            />
          ...
          <div className="artist-3">
            ...
            <img
              className="image-placeholder-icon43"
              alt=""
              src="/image-placeholder41.svg"
            />
          ...
          <div className="artist-2">
            ...
            <img
              className="image-placeholder-icon44"
              alt=""
              src="/image-placeholder41.svg"
            />
          ...
          <div className="artist-1">
            ...
            <img
              className="image-placeholder-icon45"
              alt=""
              src="/image-placeholder41.svg"
            />
          ...
          <div className="nft">
            <div className="nft-18">
              ...
              <div className="profile5">
                ...
                <img
                  className="image-placeholder-icon46"
                  alt=""
      ...
      <section className="header" id="banner">
        ...
        <div className="vector-parent">
          ...
          <img className="group-child4" alt="" src="/vector-6.svg" />
            ...
            <div className="card-bid-main">
              ...
              <div className="frame-parent">
                ...
                <div className="parent">
                  <div className="div14">$345.12</div>
                  <div className="div15">+12.45%</div>
                </div>
              </div>
      ...
      <nav className="navbar2">
        ...
        <div className="button27">
          <b className="medium3">Connect Wallet</b>
        </div>
        <div className="menu1">
          <div className="comunity5">
          ...
          <div className="artist-collectors1">{`Artist & Collectors`}</div>
          <div className="exhibition1">Exhibition</div>
